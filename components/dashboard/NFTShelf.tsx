...
const NFT_COLLECTION: NFTToken[] = [
  ...
  { id: '2', name: 'Carbon Champion', description: 'Saved your first 1 kg of CO2', rarity: 'Rare', milestone: '1 kg CO2 saved', mintDate: 'Feb 28 2024', icon: 'Bolt', gradient: 'linear-gradient(135deg, #0c3a5e, #071c33)', glowColor: 'rgba(0,217,255,0.25)', earned: true, tokenId: '#00247' },
  ...
  { id: '6', name: 'Climate Hero', description: 'Saved 5 kg CO2 total', rarity: 'Legendary', milestone: '5 kg CO2 saved', mintDate: 'Nov 22 2024', icon: 'Earth', gradient: 'linear-gradient(135deg, #3b1f00, #1c0d00)', glowColor: 'rgba(251,191,36,0.35)', earned: true, tokenId: '#07734' },
  ...
  { id: '8', name: 'Earth Defender', description: 'Save 10 kg CO2 total', rarity: 'Legendary', milestone: '10 kg CO2 saved', mintDate: '-', icon: 'Shield', gradient: 'linear-gradient(135deg, #1a1200, #0d0900)', glowColor: 'rgba(251,191,36,0.08)', earned: false, requirement: 'Save 10 kg CO2 (5.8 kg remaining)', tokenId: '#?????' },
];
