...
export default function HomeCommitmentBanner({ body, buttonLabel, highlight, imageUrl, isLight, label, titlePrefix }: HomeCommitmentBannerProps) {
  return (
    <section className="relative overflow-hidden py-[var(--page-section-space-tight)]">
      <div className="app-container">
        <motion.div className="relative overflow-hidden rounded-3xl" initial={{ opacity: 0, scale: 0.97 }} style={{ minHeight: '280px' }} viewport={{ once: true }} whileInView={{ opacity: 1, scale: 1 }}>
