...
export default function SeriesCarbonBadge({ score }: SeriesCarbonBadgeProps) {
  ...
  return <span className="text-[9px] font-black px-2 py-0.5 rounded-full" style={{ background: grade.bg, color: grade.color, border: `1px solid ${grade.border}` }}>Series impact grade {grade.label}</span>;
}
